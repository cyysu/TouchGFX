...
board_include_paths := \
	...
	$(touchgfx_path)/board/ST/STM324x9I-CUBE/include \
	$(touchgfx_path)/board/ST/STM324x9I-CUBE/include/bsp \
	$(touchgfx_path)/board/ST/STM324x9I-CUBE/source/vendor/STM324x9I_EVAL 


c_compiler_options += -DST -DSTM32F429xx -DUSE_OS_SYSTICK 
cpp_compiler_options += -DST -DSTM32F429xx -DUSE_OS_SYSTICK
