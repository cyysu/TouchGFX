...
board_include_paths := \
	...
	$(touchgfx_path)/board/ST/STM32F746G-DISCO/include \
	$(touchgfx_path)/board/ST/STM32F746G-DISCO/include/bsp \
	$(touchgfx_path)/board/ST/STM32F746G-DISCO/source/vendor/STM32746G-Discovery

c_compiler_options += -DST -DSTM32F756xx -DUSE_FREERTOS_8 -DUSE_OS_SYSTICK 
cpp_compiler_options += -DST -DSTM32F756xx -DUSE_FREERTOS_8 -DUSE_OS_SYSTICK