...
board_include_paths := \
	...
	$(touchgfx_path)/board/ST/STM32756G-EVAL/include \
	$(touchgfx_path)/board/ST/STM32756G-EVAL/include/vendor \
	$(touchgfx_path)/board/ST/STM32756G-EVAL/source/vendor/STM32756G_EVAL \

c_compiler_options += -DST -DSTM32F756xx -DUSE_FREERTOS_8 -DUSE_OS_SYSTICK -DUSE_IOEXPANDER
cpp_compiler_options += -DST -DSTM32F756xx -DUSE_FREERTOS_8 -DUSE_OS_SYSTICK -DUSE_IOEXPANDER