...
public:
     ...
     */
    Image(const Bitmap& bmp = Bitmap()) : Widget(), bitmap(bmp), alpha(255)
    {
        setWidth(bitmap.getWidth());
        setHeight(bitmap.getHeight());
        hasTransparentPixels = (bitmap.getSolidRect().width < bitmap.getWidth() || bitmap.getSolidRect().height < bitmap.getHeight());
    }

    /**
     * @fn void Image::setBitmap(const Bitmap& bmp);
     *
