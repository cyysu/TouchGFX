...
public:
     ...
     *
     *        Create an empty text area. Default color is black.
     */
    TextArea() : Widget(), typedText(TYPED_TEXT_INVALID), rotation(TEXT_ROTATE_0), color(0), linespace(0), alpha(255), indentation(0)
    { }
     ...
     *
     * @return the largest solid rectangle for this widget. For textareas, this is an empty area.
     */
     ...
     *
     * @brief Sets the linespacing of the textarea.
     *
     *        Sets the linespacing of the textarea.
     *
     * @param space The linespacing of use in the textarea.
     */
     ...
     *
     * @brief Gets the linespacing of the textarea.
     *
     *        Gets the linespacing of the textarea.
     *
