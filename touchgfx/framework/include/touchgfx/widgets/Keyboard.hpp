...
protected:
    ...
    /**
     * @fn Key Keyboard::getKeyForCoordinates(int16_t x, int16_t y);
     *
     ...
     */
    Key getKeyForCoordinates(int16_t x, int16_t y);
    ...
    /**
     * @fn CallbackArea Keyboard::getCallbackAreaForCoordinates(int16_t x, int16_t y);
     *
     ...
     */
    CallbackArea getCallbackAreaForCoordinates(int16_t x, int16_t y);

    /// This function is merely overridden to also add the Keyboard itself to the list of drawables.
