...
struct CWRUtil
{
    ...
    /**
     * @fn template <class T> inline static Q5 toQ5(T value)
     *
     ...
     */
    template <class T>
    inline static Q5 toQ5(T value)
    {
        return Q5(int(value * Rasterizer::POLY_BASE_SIZE));
    }

    /**
     * @fn template <class T> inline static Q10 toQ10(T value)
     *
     * @brief Convert an integer to a fixed point number.
     *
     *        Convert an integer to a fixed point number. This is done by shifting the integer
     ...
     */
    template <class T>
    inline static Q10 toQ10(T value)
    {
