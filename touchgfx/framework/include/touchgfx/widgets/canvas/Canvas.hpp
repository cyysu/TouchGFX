...
private:
    ...
    uint8_t isOutside(CWRUtil::Q5 y, CWRUtil::Q5 height);

    /**
     * @fn void Canvas::transformFrameBufferToDisplay(CWRUtil::Q5& x, CWRUtil::Q5& y);
     *
     ...
     */
    void transformFrameBufferToDisplay(CWRUtil::Q5& x, CWRUtil::Q5& y);
