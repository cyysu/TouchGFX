...
public:
    ...
    /**
     * @fn virtual void AbstractPainterRGB565::render(uint8_t* ptr, int x, int y, unsigned count, const uint8_t* covers);
     *
     * @brief Render part of a scan line.
     *
     *        Fill a designated part of the frame buffer with the given color with respect to
     *        the amount of coverage of each pixel given by the parameter covers.
     *
