...
public:
     ...
     *        before and after will be invalidated. This method is intended for small changes
     *        in the start point of the line.
     *
     ...
     *        and after will be invalidated. This method is intended for small changes in the
    ...
    {
        CWRUtil::Q5 widthQ5 = CWRUtil::toQ5<T>(width);
    ...
    /**
     * @fn LINE_ENDING_STYLE Line::getLineEndingStyle();
     *
