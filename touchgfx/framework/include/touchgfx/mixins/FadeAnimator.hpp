...
protected:
    ...
    virtual void handleTickEvent()
    {
        ...
        if (fadeAnimationRunning)
        {
            ...
            else if (fadeAnimationCounter <= (uint32_t)(fadeAnimationDelay + fadeAnimationDuration))
            {
                ...
                uint8_t deltaAlpha = (uint8_t) fadeAnimationAlphaEquation(actualAnimationCounter, 0, fadeAnimationEndAlpha - fadeAnimationStartAlpha, fadeAnimationDuration);
