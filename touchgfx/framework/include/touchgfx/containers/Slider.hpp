...
public:
     ...
     *                      greater than indicatorMinX.
     */
    void setupVerticalSlider(uint16_t backgroundX, uint16_t backgroundY, uint16_t indicatorX, uint16_t indicatorMinY, uint16_t indicatorMaxY);
     ...
     */
    void setValueRange(int minValue, int maxValue, int newValue);
...
protected:
     ...
     *                 vertical mode).
     */
    void updateIndicatorPosition(int16_t position);

    /**
     * @fn int16_t Slider::valueToPosition(int value);
     *
     ...
     */
    int16_t valueToPosition(int value);

    /**
     * @fn int Slider::positionToValue(int16_t position);
     *
     ...
     */
    int positionToValue(int16_t position);

    /**
     * @fn uint16_t Slider::getIndicatorRadius();
     *
     * @brief Gets the indicator radius.
     *
     * @return The the indicator radius.
     */
    uint16_t getIndicatorRadius();

    /**
     * @fn int Slider::getIndicatorPositionRangeSize();
     *
     * @brief Gets the indicator position range size.
     *
     * @return The indicator position range size.
     */
    int getIndicatorPositionRangeSize();

    /**
     * @fn int Slider::getValueRangeSize();
     *
     * @brief Gets the value range size.
     *
     * @return The value range size.
     */
    int getValueRangeSize();
};
