...
public:
     ...
     *
     *        Adds a widget to the list of widgets receiving ticks every TICK_INTERVAL_MS
     *        milliseconds.
     *
     ...
     *
     *        Removes a widget from the list of widgets receiving ticks every TICK_INTERVAL_MS
     *        milliseconds.
     *
    ...
    static const uint16_t TICK_INTERVAL_MS     = 10; ///< Tick interval in milliseconds. How accurate this is depends on platform.
