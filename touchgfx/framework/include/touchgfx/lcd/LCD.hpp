...
public:
    ...
    struct StringVisuals
    {
         ...
         */
        StringVisuals() :
            font(0), alignment(LEFT), textDirection(TEXT_DIRECTION_LTR), rotation(TEXT_ROTATE_0), color(0), alpha(255), linespace(0), indentation(0)
        {
        }

        /**
         * @fn StringVisuals(const Font* font, colortype color = 0, uint8_t alpha = 255, Alignment alignment = LEFT, uint16_t linespace = 0, TextRotation rotation = TEXT_ROTATE_0, TextDirection textDirection = TEXT_DIRECTION_LTR, uint8_t indentation = 0)
         *
         ...
         *                      area rectangle.
         */
        StringVisuals(const Font* font, colortype color = 0, uint8_t alpha = 255, Alignment alignment = LEFT, uint16_t linespace = 0, TextRotation rotation = TEXT_ROTATE_0, TextDirection textDirection = TEXT_DIRECTION_LTR, uint8_t indentation = 0)
        {
            this->font = font;
            this->color = color;
            this->alpha = alpha;
...
protected:
    ...
    /**
     * @fn static int LCD::realX(Rect& widgetArea, int16_t x, int16_t y, TextRotation rotation);
     *
     ...
     */
    static int realX(Rect& widgetArea, int16_t x, int16_t y, TextRotation rotation);

    /**
     * @fn static int LCD::realY(Rect& widgetArea, int16_t x, int16_t y, TextRotation rotation);
     *
     ...
     */
    static int realY(Rect& widgetArea, int16_t x, int16_t y, TextRotation rotation);

    /**
     * @fn void LCD::drawStringLTR(Rect widgetArea, const Rect& invalidatedArea, StringVisuals& stringVisuals, const Unicode::UnicodeChar* format, va_list pArg);
     *
     * @brief Draws the specified unicode string.
     *
     ...
     * @see drawString
     */
    void drawStringLTR(Rect widgetArea,
                       const Rect& invalidatedArea,
                       StringVisuals& stringVisuals,
                       const Unicode::UnicodeChar* format,
                       va_list pArg);
    ...
    /**
     * @fn void LCD::drawStringRTL(Rect widgetArea, const Rect& invalidatedArea, StringVisuals& stringVisuals, const Unicode::UnicodeChar* format, va_list pArg);
     *
     * @brief Draws the specified unicode string.
     *
     ...
     * @see drawString
     */
    void drawStringRTL(Rect widgetArea,
                       const Rect& invalidatedArea,
                       StringVisuals& stringVisuals,
                       const Unicode::UnicodeChar* format,
                       va_list pArg);
...
private:
    typedef void (LCD::*DrawStringFunctionPointer)(Rect widgetArea, const Rect& invalidatedArea, StringVisuals& stringVisuals, const Unicode::UnicodeChar* format, va_list _pArg);
    ...
    typedef void (LCD::*DrawStringInternalFunctionPointer)(int16_t& offset, const Font* font, const TextDirection textDirection, TextProvider& widthTextProvider, const int numChars, DrawStringInternalStruct* data);
    void drawStringRTLLine(int16_t& offset, const Font* font, TextDirection textDirection, Unicode::UnicodeChar& currChar, TextProvider& textProvider, TextProvider& widthTextProvider, DrawStringInternalFunctionPointer internalFunction, DrawStringInternalStruct* data);
    void drawStringWidthInternal(int16_t& offset, const Font* font, const TextDirection textDirection, TextProvider& textProvider, const int numChars, DrawStringInternalStruct* data);
    void drawStringRTLInternal(int16_t& offset, const Font* font, const TextDirection textDirection, TextProvider& widthTextProvider, const int numChars, DrawStringInternalStruct* data);
    bool drawStringInternal(uint16_t* frameBuffer, Rect* widgetArea, int16_t widgetRectY, int16_t& offset, const Rect& invalidatedArea, StringVisuals* stringVisuals, const TextDirection textDirection, TextProvider& textProvider, const int numChars);
};
