...
protected:
    ...
    /**
     * @fn Font::Font(uint16_t height, uint8_t pixBelowBase, uint8_t bitsPerPixel, uint8_t maxLeft, uint8_t maxRight)
     *
     * @brief Constructor.
     *
     ...
     */
    Font(uint16_t height, uint8_t pixBelowBase, uint8_t bitsPerPixel, uint8_t maxLeft, uint8_t maxRight) : fontHeight(height), pixelsBelowBaseline(pixBelowBase), bPerPixel(bitsPerPixel), maxPixelsLeft(maxLeft), maxPixelsRight(maxRight) { }
