 ...
 *
 *****************************************************************************/
#ifndef I2C_LPC43XX_HPP
#define I2C_LPC43XX_HPP
...
{
/**
 * NXP LPC43XX MCU specific I2C driver.
 */
class I2C_LPC43xx : public I2C
{
public:
    /**
     ...
     */
    I2C_LPC43xx(uint8_t ch) : I2C(ch)
    {}

    /**
     * Initializes the I2C driver. Sets up SDA and SDL and intialize I2C peripheral.
     */
    virtual void init();
     ...
     */
    virtual bool readRegister(uint8_t addr, uint8_t reg, uint8_t* data, uint32_t cnt);
     ...
     * @return true on success, false otherwise.
     */
    virtual bool writeRegister(uint8_t addr, uint8_t reg, uint8_t val);
...
private:
    ...
    */
    ...
    /**
     * LPC43xx I2C channel handle
     */
    LPC_I2Cn_Type* chHndl;
};
}

#endif // I2C_LPC43XX_HPP
