 ...
 *
 *****************************************************************************/
#ifndef NXP4088DMA_HPP
#define NXP4088DMA_HPP
...
/**
 * @class NXP4088DMA NXP4088DMA.hpp platform/hal/nxp/mcu/LPC17xx/NXP4088DMA.hpp
 *
 * @brief This class specializes DMA_Interface for the NXP 4088 processor.
 *
 *        This class specializes DMA_Interface for the NXP 4088 processor.
 *
 * @sa DMA_Interface
 */
class NXP4088DMA : public DMA_Interface
{
    /**
...
public:
    /**
     * @fn NXP4088DMA::NXP4088DMA(GPDMA_LLI_Type* lliMemory);
     *
     * @brief Constructor.
     *
     *        Constructor.
     ...
     */
    NXP4088DMA(DMA_TransferDescriptor_t* lliMemory);

    /**
     * @fn NXP4088DMA::~NXP4088DMA();
     *
     * @brief Destructor.
     *
     *        Destructor.
    ...
    /**
     * @fn virtual BlitOperations NXP4088DMA::getBlitCaps()
     *
    ...
    /**
     * @fn void NXP4088DMA::signalDMAInterrupt();
     *
...
protected:
    /**
     * @fn virtual void NXP4088DMA::setupDataCopy(const BlitOp& blitOp);
     *
    ...
    /**
     * @fn virtual void NXP4088DMA::setupDataFill(const BlitOp& blitOp);
     *
...
private:
    ...
    DMA_TransferDescriptor_t*   MyLLI;        ///< GPDMA scatter-gather linked list memory
