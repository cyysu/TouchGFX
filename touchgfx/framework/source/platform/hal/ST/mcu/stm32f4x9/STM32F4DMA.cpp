...
void STM32F4DMA::setupDataCopy(const touchgfx::BlitOp& blitOp)
{
    ...
    DMA2D_FG_InitStruct.DMA2D_FG_CLUT_CM = dma2dColorMode;
    ...
    if (blendingImage || blendingText)
    {
        ...
        DMA2D_BG_InitStruct.DMA2D_BG_CLUT_CM = (bitDepth == 16) ? CM_RGB565 : CM_RGB888;
...
void STM32F4DMA::setupDataFill(const touchgfx::BlitOp& blitOp)
{
    ...
    if (bitDepth == 16)
    {
        ...
        green = (((blitOp.color & 0x7E0) >> 5) * 255) / 63;
