...
BlitOperations STM32F4DMA::getBlitCaps()
{
    ...
    {
        return static_cast<BlitOperations>(BLIT_OP_FILL | BLIT_OP_COPY_WITH_ALPHA | BLIT_OP_COPY | BLIT_OP_COPY_ARGB8888 | BLIT_OP_COPY_ARGB8888_WITH_ALPHA | BLIT_OP_COPY_A4 | BLIT_OP_COPY_A8);
    }
}
