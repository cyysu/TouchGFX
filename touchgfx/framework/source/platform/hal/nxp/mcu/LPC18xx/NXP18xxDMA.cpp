...
NXP18XXDMA::NXP18XXDMA(GPDMA_LLI_Type* lliMemory)
...
NXP18XXDMA::~NXP18XXDMA()
{
}


void NXP18XXDMA::initialize()
{
}
...
void NXP18XXDMA::signalDMAInterrupt(void)
{
...
void NXP18XXDMA::setupDataCopy(const BlitOp& blitOp)
{
...
void NXP18XXDMA::setupDataFill(const BlitOp& blitOp)
{
    numLines = blitOp.nLoops;
    while (LPC_GPDMA->ENBLDCHNS) ;
    GPDMA_Channel_CFG_Type GPDMACfg;
