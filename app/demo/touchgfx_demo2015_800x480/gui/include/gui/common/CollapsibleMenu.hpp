...
public:
    ...
    /**
     * @fn void CollapsibleMenu::addMenuElement(const Bitmap& elementBitmap, const Bitmap& elementPressedBitmap);
     *
     * @brief Adds a menu element.
     *
     * @param elementBitmap        The element bitmap.
     * @param elementPressedBitmap The element pressed bitmap.
     */
