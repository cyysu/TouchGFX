...
/**
 * @class Gauge Gauge.hpp gui/custom_controls_screen/Gauge.hpp
 *
 * @brief A gauge.
 *
...
public:
    ...
    /**
     * @class Needle Gauge.hpp gui/custom_controls_screen/Gauge.hpp
     *
    ...
    /**
     * @class NeedleShadow Gauge.hpp gui/custom_controls_screen/Gauge.hpp
     *
