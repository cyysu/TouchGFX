...
public:
    ...
    {
        return selectedDemoScreenIndex;
    }
    void setSelectedDemoScreenIndex(int index)
    {
        selectedDemoScreenIndex = index;
    }
    ...
    MainMenuType getPreviousSelectedMainMenuType()
    {
        return previousSelectedMenuType;
    }
    void setPreviousSelectedMainMenuType(MainMenuType menu)
    {
