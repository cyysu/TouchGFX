...
public:
    ...
    {
        return static_cast<ExtendedZoomAnimationImage*>(&(visibleElements[selectedElement]));
    }
     ...
     */
    virtual Bitmaps getSelectedElementBitmaps() const
    {
    ...
    {
        carouselAnimationEndedAction = &callback;
    }
