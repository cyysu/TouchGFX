    ...
    moveAnimationEnded(this, &FeaturePoster::moveAnimationEndedHandler)
{
    ...
    startAnimationButton.setXY(202, 212);
    ...
    startAnimationButtonArrow.setXY(startAnimationButton.getX() + 29, startAnimationButton.getY() + 25);
...
void FeaturePoster::setHeadlineColor(colortype color)
{
...
void FeaturePoster::animate()
{
    if (currentState == SHOWING_IMAGE)
    {
        ...
        int startAnimationButtonEndY = alphaBox.getHeight() - startAnimationButton.getHeight() + 15;
        ...
        startAnimationButtonArrow.startMoveAnimation(startAnimationButton.getX() + 29, startAnimationButtonEndY + 25, 25, EasingEquations::linearEaseNone, EasingEquations::quadEaseInOut);
    ...
    else if (currentState == SHOWING_TEXT)
    {
        ...
        startAnimationButton.startMoveAnimation(startAnimationButton.getX(), 217, 25, EasingEquations::linearEaseNone, EasingEquations::quadEaseInOut);
        startAnimationButtonArrow.startMoveAnimation(startAnimationButton.getX() + 29, 217 + 25, 25, EasingEquations::linearEaseNone, EasingEquations::quadEaseInOut);
