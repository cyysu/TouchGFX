...
#ifdef LPC4350
// The demo app was designed to run on MCUs like NXP-LPC4353, ST-STM32F429 or similar.
// When running on MCUs with less computational power some demo screens are omitted.
#define REDUCED_PERFORMANCE
#endif
...
public:
    ...
    void gotoNXPAndTouchGFXScreen();
    void gotoFlowPresentationScreen();
    void gotoAnimatedGraphicsScreen();
    void gotoHomeAutomationScreen();
    void gotoListNavigationScreen(bool play);
    void gotoLiveDataDisplayScreen();
    void gotoDataVisualizationScreen();
    void gotoClockScreen();
...
private:
    ...
    void gotoNXPAndTouchGFXScreenImpl();
    void gotoFlowPresentationScreenImpl();
    void gotoAnimatedGraphicsScreenImpl();
    void gotoHomeAutomationScreenImpl();
    void gotoListNavigationScreenImpl();
    void gotoLiveDataDisplayScreenImpl();
    void gotoDataVisualizationScreenImpl();
    void gotoClockScreenImpl();
