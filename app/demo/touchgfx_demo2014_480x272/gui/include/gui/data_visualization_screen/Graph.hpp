...
static const uint16_t graphWidth = 379;
static const uint16_t graphHeight = 254;
static const uint16_t graphPointsInsideGraphWindow = 7;
static const uint16_t graphAlphasPerColumn = 15;
static const float graphLineWidth = 0.3f;
static const float graphLineBlur = 2.5f;
static colortype graphColor = 0;
static colortype graphBlendColor = 0;
