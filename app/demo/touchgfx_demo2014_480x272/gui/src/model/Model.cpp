    ...
    mcuLoadActive(true)
{
    ...
    roomTemperatureInfo[0].setCurrentTemperature(20);
    ...
    roomTemperatureInfo[1].setCurrentTemperature(21);
    ...
    roomTemperatureInfo[2].setCurrentTemperature(22);
    ...
    roomTemperatureInfo[3].setCurrentTemperature(23);
    ...
    roomTemperatureInfo[5].setCurrentTemperature(25);
    ...
    roomTemperatureInfo[6].setCurrentTemperature(26);
    ...
    roomTemperatureInfo[7].setCurrentTemperature(27);
