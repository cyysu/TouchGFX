    ...
    : counter(0)
{
    ...
    graphBlendColor = Color::getColorFrom24BitRGB(0xFF, 0xFF, 0xFF);
    ...
    {
        values[i] = (int16_t)generateValue();
    }
}
...
void Graph::calculate()
{
    ...
    values[unusedIndex] = (int16_t)generateValue();
...
float Graph::generateValue()
{
    return randomNumberBetween(graphTopMargin, getHeight() - graphBottomMargin);
}
