...
WeekInfo::WeekInfo()
{
    ...
    smallIcons[3].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_CLOUD_ID));
    smallIcons[3].setXY(smallIcons[0].getX() + 3 * smallIconDiff, 10);
    smallIcons[4].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_CLOUD_ID));
    smallIcons[4].setXY(smallIcons[0].getX() + 4 * smallIconDiff, 10);

    days[0].setTypedText(TypedText(T_WEATHER_DAY_0));
    days[0].setPosition(60, 11, 30, 16);
    ...
    days[3].setTypedText(TypedText(T_WEATHER_DAY_3));
    days[3].setPosition(days[0].getX() + 3 * smallIconDiff, 10, 30, 16);
    days[4].setTypedText(TypedText(T_WEATHER_DAY_4));
    days[4].setPosition(days[0].getX() + 4 * smallIconDiff, 10, 30, 16);

    smallTemperature->setX(60);
...
void WeekInfo::setInfo(CityInfo::Cities city)
{
    ...
    case CityInfo::COPENHAGEN:
        ...
        Unicode::snprintf(smallTemperatureBuffer[3], 4, "%d", 18);
        Unicode::snprintf(smallTemperatureBuffer[4], 4, "%d", 17);
        break;
    ...
    case CityInfo::HONG_KONG:
        ...
        smallIcons[3].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_THUNDER_ID));
        smallIcons[4].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_CLOUD_ID));
        Unicode::snprintf(smallTemperatureBuffer[0], 4, "%d", 23);
        Unicode::snprintf(smallTemperatureBuffer[1], 4, "%d", 19);
        Unicode::snprintf(smallTemperatureBuffer[2], 4, "%d", 21);
        Unicode::snprintf(smallTemperatureBuffer[3], 4, "%d", 16);
        Unicode::snprintf(smallTemperatureBuffer[4], 4, "%d", 17);
        break;
    ...
    case CityInfo::MUMBAI:
        ...
        smallIcons[1].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_SUN_BIGCLOUD_ID));
        smallIcons[2].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_SUN_ID));
        smallIcons[3].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_SUN_ID));
        smallIcons[4].setBitmap(Bitmap(BITMAP_WEATHER_SMALL_ICON_CLOUD_ID));
        ...
        Unicode::snprintf(smallTemperatureBuffer[3], 4, "%d", 28);
        Unicode::snprintf(smallTemperatureBuffer[4], 4, "%d", 30);
        break;
    ...
    case CityInfo::NEW_YORK:
        ...
        Unicode::snprintf(smallTemperatureBuffer[3], 4, "%d", 17);
        Unicode::snprintf(smallTemperatureBuffer[4], 4, "%d", 19);
        break;
