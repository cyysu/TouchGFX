 ...
 *
 *****************************************************************************/
#ifndef AIR_CONDITION_PRESENTER_HPP
#define AIR_CONDITION_PRESENTER_HPP
 ...
 *
 */
class AirConditionPresenter : public BasePresenter
{
public:
    AirConditionPresenter(AirConditionView& v);

    virtual ~AirConditionPresenter() {};
    ...
    void roomAirConTempUpdated(Room room, int16_t value);
private:
    AirConditionPresenter();
    AirConditionView& view;
};
