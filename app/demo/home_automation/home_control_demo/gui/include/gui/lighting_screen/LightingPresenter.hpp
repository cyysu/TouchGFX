 ...
 *
 *****************************************************************************/
#ifndef LIGHTING_PRESENTER_HPP
#define LIGHTING_PRESENTER_HPP
 ...
 *
 */
class LightingPresenter : public BasePresenter
{
public:
    ...
    void roomLightingUpdated(Room room, int16_t value);
