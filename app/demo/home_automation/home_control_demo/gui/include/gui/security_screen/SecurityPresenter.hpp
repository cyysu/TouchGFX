 ...
 *
 *****************************************************************************/
#ifndef SECURITY_PRESENTER_HPP
#define SECURITY_PRESENTER_HPP
 ...
 *
 */
class SecurityPresenter : public BasePresenter
{
public:
    ...
    /**
     * The following functions are used by the view
     */
    void roomChanged();
    void setSecurityForAllRooms(bool active);

    /**
     * ModelListener
     */
    virtual void securityChanged();
private:
    SecurityPresenter();
