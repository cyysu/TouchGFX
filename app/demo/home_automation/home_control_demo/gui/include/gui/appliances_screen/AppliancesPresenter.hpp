 ...
 *
 *****************************************************************************/
#ifndef APPLIANCES_PRESENTER_HPP
#define APPLIANCES_PRESENTER_HPP

#include <gui/common/BasePresenter.hpp>

class AppliancesView;
 ...
 *
 */
class AppliancesPresenter : public BasePresenter
{
public:
    AppliancesPresenter(AppliancesView& v);
