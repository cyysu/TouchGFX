 ...
 *
 *****************************************************************************/
#ifndef BLINDS_PRESENTER_HPP
#define BLINDS_PRESENTER_HPP
 ...
 *
 */
class BlindsPresenter : public BasePresenter
{
public:
    BlindsPresenter(BlindsView& v);
    ...
    virtual ~BlindsPresenter() {};

    void blindsSelected(int16_t selectedBlind, uint16_t numberOfSelectedBlinds);
    void roomBlindsPercentageUpdated(Room room, int16_t value);
