 ...
 *
 *****************************************************************************/
#ifndef ENTERTAINMENT_PRESENTER_HPP
#define ENTERTAINMENT_PRESENTER_HPP
 ...
 *
 */
class EntertainmentPresenter : public BasePresenter
{
public:
    EntertainmentPresenter(EntertainmentView& v);
    ...
    virtual ~EntertainmentPresenter() {};

    void setCurrentAlbum(uint8_t currentAlbum);
    void setCurrentNumber(uint8_t currentSelectedNumber);
private:
    EntertainmentPresenter();
