...
public:
    ...
    //from UI when user clicks the background/play button
    void backgroundClicked();
    void playPressed();

    //from state changes from model
    virtual void showError(uint16_t e);
    virtual void mounted(bool m);
    virtual void showBitmap(BMPFileLoader::FileHdl f);
