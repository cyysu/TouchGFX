...
public:
     ...
     */
    MainView() :
        clockwiseClickedCallback(this, &MainView::clockwiseClicked),
        antiClockwiseClickedCallback(this, &MainView::antiClockwiseClicked),
...
private:
    void clockwiseClicked(const AbstractButton& source);
    void antiClockwiseClicked(const AbstractButton& source);

    Image img;

    ButtonWithLabel clockwiseButton;
    ButtonWithLabel antiClockwiseButton;
    Callback<MainView, const AbstractButton&> clockwiseClickedCallback;
    Callback<MainView, const AbstractButton&> antiClockwiseClickedCallback;
