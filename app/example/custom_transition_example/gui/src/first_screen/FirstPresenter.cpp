...
void FirstPresenter::goToSecondScreen()
{
    //Get the Application instance and call call goToSecondScreen().
    //
    static_cast<FrontendApplication*>(FrontendApplication::getInstance())->gotoSecondScreen();
}
