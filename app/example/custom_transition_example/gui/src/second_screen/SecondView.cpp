...
void SecondView::setupScreen()
{
    //Set the bitmap on the background.
    background.setBitmap(Bitmap(BITMAP_SECOND_BG_ID));
    ...
    changeScreenBtn.setLabelText(TypedText(T_CHANGE_TO_SCREEN_1));
...
void SecondView::tearDownScreen()
{

}

void SecondView::changeScreenBtnClicked(const AbstractButton&)
{
    //Tell the presenter to initiate a screen change.
    presenter->goToFirstScreen();
}

void SecondView::afterTransition()
{
