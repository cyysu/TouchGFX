...
public:
     ...
     */
    FirstView() : changeScreenBtn(), background(), changeScreenBtnClickedCallback(this, &FirstView::changeScreenBtnClicked)
    {
    }
    virtual ~FirstView() { }
...
private:
    ...
    Image background;
    Callback<FirstView, const AbstractButton&> changeScreenBtnClickedCallback;
};
