 ...
 *
 *****************************************************************************/
#ifndef SECOND_PRESENTER_HPP
#define SECOND_PRESENTER_HPP
 ...
 *
 */
class SecondPresenter : public Presenter, public ModelListener
{
public:
    SecondPresenter(SecondView& v);
