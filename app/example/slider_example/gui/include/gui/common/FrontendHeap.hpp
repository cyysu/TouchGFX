...
public:
     ...
     */
    typedef meta::TypeList<MainView, meta::Nil> ViewTypes;
     ...
     */
    typedef meta::TypeList<MainPresenter, meta::Nil> PresenterTypes;
     ...
     */
    typedef meta::TypeList<NoTransition, meta::Nil> TransitionTypes;
...
private:
    FrontendHeap() :
        MVPHeap(presenters, views, transitions, app), presenters(), views(), transitions(), app(
            model, *this)
    {
        // Goto start screen
        app.gotoMainScreen();
