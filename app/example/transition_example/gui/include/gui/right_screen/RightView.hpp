 ...
 * automatically.
 */
class RightView : public View<RightPresenter>
{
public:
    /**
     ...
     */
    RightView()
        : buttonClickedCallback(this, &RightView::buttonClicked)
    {
    }
    virtual ~RightView() { }
...
private:
    Image img;
    Button btnLeft;
    Callback<RightView, const AbstractButton&> buttonClickedCallback;
