...
public:
    ...
    void gotoMainScreenFromLeftScreen();
    void gotoMainScreenFromRightScreen();
    void gotoMainScreenFromUpScreen();
    void gotoMainScreenFromDownScreen();

    void gotoLeftScreenFromMainScreen();
    void gotoRightScreenFromMainScreen();
    void gotoUpScreenFromMainScreen();
    void gotoDownScreenFromMainScreen();
...
private:
    ...
    void gotoMainScreenFromLeftScreenImpl();
    void gotoMainScreenFromRightScreenImpl();
    void gotoMainScreenFromUpScreenImpl();
    void gotoMainScreenFromDownScreenImpl();

    void gotoLeftScreenFromMainScreenImpl();
    void gotoRightScreenFromMainScreenImpl();
    void gotoUpScreenFromMainScreenImpl();
    void gotoDownScreenFromMainScreenImpl();
};
